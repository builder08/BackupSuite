...
class BackupStart(Screen):
    ...
    def __init__(self, session, args = 0):
        ...
        self['setupActions'] = ActionMap(['SetupActions',
         'ColorActions',
         'EPGSelectActions',
         'HelpActions'], {'menu': self.confirmmmc,
         'red': self.cancel,
    ...
    def showparameterlist(self):
        if self['key_green'].getText() == _('Run flash'):
            ...
            if dirname:
                ...
                elif model in ('hd51', 'h7', 'sf4008', 'sf5008', 'sf8008', 'vs1500', 'et11000', 'et13000', 'bre2ze4k', 'spycat4k', 'spycat4kmini', 'protek4k', 'e4hdultra', 'cc1', 'spycatminiv2', 'iziboxecohd', 'jdhdduo', 'turing', 'arivacombo', 'arivatwin') or model.startswith(('anadol', 'axashis4', 'dinobot4', 'ferguson4', 'mediabox4', 'axashisc4')):
                    backup_files = ['kernel.bin', 'rootfs.tar.bz2']
                    no_backup_files = ['kernel_cfe_auto.bin',
                     'rootfs.bin',
                     'root_cfe_auto.jffs2',
                ...
                if self.founds:
                    ...
                    open_list2 = [(_('Simulate second partition (no write)'), 'simulate2'),
...
def Plugins(path, **kwargs):
    global plugin_path
    plugin_path = path
    return [PluginDescriptor(name=_('BackupSuite'), description=_('Backup and restore your image') + ', ' + versienummer, where=PluginDescriptor.WHERE_PLUGINMENU, icon='plugin.png', fnc=main), PluginDescriptor(name=_('BackupSuite'), description=_('Backup and restore your image') + ', ' + versienummer, where=PluginDescriptor.WHERE_EXTENSIONSMENU, fnc=main)]
